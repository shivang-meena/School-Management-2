...
async function main() {
  ...
  await prisma.user.upsert({
    ...
    create: {
      loginId: 'admin', name: 'School Administrator', email: 'admin@arihantpublicschool.edu',
      passwordHash, role: Role.ADMIN, mustChangePassword: false,
    },
  });
  ...
  const year = await prisma.academicYear.upsert({
    ...
    create: { name: '2026-27', startDate: new Date('2026-04-01'), endDate: new Date('2027-03-31'), isCurrent: true },
  });
  ...
  for (const subject of [{ code: 'ENG', name: 'English' }, { code: 'HIN', name: 'Hindi' }, { code: 'MAT', name: 'Mathematics' }, { code: 'SCI', name: 'Science' }, { code: 'SST', name: 'Social Studies' }, { code: 'CSE', name: 'Computer Science' }]) {
